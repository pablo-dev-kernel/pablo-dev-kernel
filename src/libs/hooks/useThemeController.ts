...
export const useThemeController = () => {
  ...
  const UI_COLORS = {
    ...
    card: "bg-stone-300 hover:bg-stone-200 dark:bg-stone-700 hover:dark:bg-stone-800 shadow-md hover:shadow-stone-700 cursor-pointer transition-all",
    cardWhite: "bg-stone-300 hover:bg-stone-200 shadow-md hover:shadow-stone-700 cursor-pointer transition-all",
  }
