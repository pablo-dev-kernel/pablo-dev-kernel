  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <input
        accept={accept}
        checked={checked}
        className={`bg-stone-300 dark:bg-stone-800 text-stone-800 dark:text-stone-200 outline outline-2 ${tones.outlineColor.normal} focus:${tones.outlineColor.light} p-1 md:px-2 rounded-lg ${styles}`}
